...
Agent C 阅读 Agent B 输出和实际 diff，核对测试结果，判断是否满足人工目标和 Agent A 提示词。验收后必须更新 `md/flow/flow.md`、`md/flow/flowchart.md`，重要事项写入 `update_log.md`，并输出通过/不通过、问题清单、已更新文档和下一步建议。
